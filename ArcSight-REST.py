...
class ArcsightLogger(object):
    ...
    TARGET = 'https://192.168.2.26:9000'
    ...
    def search(self, query, seconds):
        ...
        response = self._post(
            '/server/search', data={
                ...
                'end_time': self.format_time(0, seconds)
            })
...
if __name__ == '__main__':
    arcsight = ArcsightLogger('admin', 'Pr3d4t0r89', False)
    print arcsight.token
    query = '_deviceGroup in ["Logger Internal Event Device"]'
    print query
    search_id, r = arcsight.search(query, 10)
    print search_id
    print r
    arcsight.wait(search_id)
    events = arcsight.histogram(search_id)
    print events
